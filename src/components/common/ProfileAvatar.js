        ...
        <div className="profile-avatar">
            ...
            <div onClick={logoutHandler} className="logout">
                <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11 19l1-1h6V6h-6a1 1 0 010-2h6l2 2v12l-2 2h-6l-1-1z" fill="#fff" fillOpacity=".6" />
                    <path d="M16 13l-1 1h-5v1l-1 1-5-3v-2l5-3 1 1v1h5l1 1v2z" fill="#fff" fillOpacity=".6" />
                </svg>
            </div>
        </div>
    )
